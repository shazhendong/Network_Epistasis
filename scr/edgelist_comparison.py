...
# Parameters: edgelist1, edgelist2
# Output: common_edges.csv, edgelist1_only.csv, edgelist2_only.csv
...
# save the df to csv
df_common_edges.to_csv('common_edges.csv', index=False)
df_G1_only_edges.to_csv('edgelist1_only.csv', index=False)
df_G2_only_edges.to_csv('edgelist2_only.csv', index=False)